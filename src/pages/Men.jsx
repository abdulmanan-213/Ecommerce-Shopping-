...
// Initial orders data for Men's page
const initialOrders = [
  {
    id: 2001,
    date: "18 Jan 2024",
    ...
    items: [
      ...
      { name: "Men's Polo T-Shirt", image: "https://images.unsplash.com/photo-1586790170083-2f9ceadc732d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80" }
    ]
  },
  {
    id: 2002,
    ...
    status: "Shipped",
    items: [
      { name: "Men's Winter Jacket", image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?ixlib=rb-4.0.3&id=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" },
  ...
  },
  {
    ...
    status: "Delivered",
    items: [
      { name: "Men's Silk Kurta", image: "https://images.unsplash.com/photo-1581044777550-4cfa60707c03?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=772&q=80" },
      { name: "Men's Ethnic Kurta", image: "https://images.unsplash.com/photo-1572804013427-4d7ca7268217?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1035&q=80" }
    ]
  }
];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 mb-10 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h1 className="text-3xl md:text-4xl font-bold mb-3">Men's Fashion Collection</h1>
                <p className="text-lg mb-4">Discover the latest trends in men's clothing at unbeatable prices</p>
                <div className="flex flex-wrap gap-3">
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">Shirts</span>
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">Jeans</span>
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">Formal Wear</span>
