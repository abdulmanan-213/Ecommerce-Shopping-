...
const kidsProducts = [
  {
    ...
    discount: "44% OFF",
    save: "₹400",
    image: "https://images.unsplash.com/photo-1620428268482-cf1851a36764?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    rating: 4.5,
    reviews: 124,
  },
  {
  ...
  {
    id: 305,
    name: "Toddler Jumpsuit",
    price: "₹699",
    oldPrice: "₹1199",
    discount: "42% OFF",
    save: "₹500",
    image: "https://images.unsplash.com/photo-1596492784531-6e6eb5ea9993?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    rating: 4.4,
    reviews: 78,
  },
  {
    ...
    discount: "41% OFF",
    save: "₹700",
    image: "https://images.unsplash.com/photo-1539185441755-769473a23570?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80",
    rating: 4.2,
    reviews: 95,
  },
  {
...
// Initial orders data for Kids page
const initialOrders = [
  {
    id: 3001,
    date: "18 Jan 2024",
    ...
    status: "Processing",
    items: [
      { name: "Kids Cartoon T-Shirt", image: "https://images.unsplash.com/photo-1620428268482-cf1851a36764?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80" },
      { name: "Kids Pajama Set", image: "https://images.unsplash.com/photo-1596492784531-6e6eb5ea9993?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80" }
    ]
  },
  {
    id: 3002,
    ...
    status: "Shipped",
    items: [
      { name: "Kids Winter Jacket", image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?ixlib=rb-4.0.3&id=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" },
      { name: "Kids Sports Tracksuit", image: "https://images.unsplash.com/photo-1539185441755-769473a23570?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80" }
    ]
  },
  {
    id: 3003,
    ...
    status: "Delivered",
    items: [
      { name: "Kids Party Dress", image: "https://images.unsplash.com/photo-1539008835657-9e8e9680c956?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80" },
      { name: "Kids Shoes Pack", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" }
    ]
  }
];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 mb-10 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h1 className="text-3xl md:text-4xl font-bold mb-3">Kids Fashion Collection</h1>
                <p className="text-lg mb-4">Discover adorable kids clothing at unbeatable prices</p>
                <div className="flex flex-wrap gap-3">
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">Boys</span>
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">Girls</span>
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">Babies</span>
                  <span className="bg-white/20 px-3 py-1 rounded-full text-sm">School Wear</span>
            ...
            <div className="flex justify-between items-center mb-10">
              <div>
                ...
                <p className="text-gray-500 mt-2">
                  Limited time offers on adorable kids clothing
                </p>
              </div>
              <a
                href="#"
                className="text-yellow-600 text-sm font-medium flex items-center hover:text-yellow-800 transition-colors group bg-yellow-50 px-4 py-2 rounded-lg"
              >
                View All{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {kidsProducts.map((product) => (
                ...
                >
                  ...
                  <div className="h-48 flex items-center justify-center p-3 relative mb-4 overflow-hidden rounded-xl bg-gradient-to-br from-yellow-50 to-pink-50">
                    <img
                      src={product.image}
                      alt={product.name}
                  ...
                  <div className="mt-2 flex-grow">
                    <h3 className="text-md font-semibold text-gray-800 line-clamp-2 mb-3 group-hover:text-yellow-600 transition-colors">
                      {product.name}
                    </h3>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className=" p-6 rounded-2xl border border-yellow-100">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">Kid-Friendly Materials</h3>
                </div>
                <p className="text-gray-600">All products are made from soft, hypoallergenic materials safe for kids' delicate skin.</p>
              </div>

              <div className="bg-gradient-to-br from-yellow-50 to-pink-50 p-6 rounded-2xl border border-yellow-100">
                <div className="flex items-center mb-4">
                  <div className="bg-yellow-100 p-3 rounded-xl mr-4">
                    <svg className="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-yellow-50 p-6 rounded-2xl border border-pink-100">
                <div className="flex items-center mb-4">
