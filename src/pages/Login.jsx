...
export default function Login({ switchToSignup, onLoginSuccess }) {
  ...
  const handleLogin = (e) => {
    ...
    const users = JSON.parse(localStorage.getItem('megamart_users') || '[]');
    ...
    // In a real app, you would validate password hash here
    // For demo, we'll accept any password for existing users
    // You could add password validation: if (user.password !== form.password)
    ...
    localStorage.setItem('megamart_users', JSON.stringify(updatedUsers));
    ...
    // Set remember me
    if (form.rememberMe) {
      localStorage.setItem('megamart_remembered_user', JSON.stringify({
        email: form.email,
        rememberMe: true
      }));
    } else {
      localStorage.removeItem('megamart_remembered_user');
    }
  ...
  React.useEffect(() => {
    const remembered = localStorage.getItem('megamart_remembered_user');
    if (remembered) {
          ...
          <div className="bg-white rounded-3xl p-8 max-w-md w-full mx-4 shadow-2xl">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Great to see you again, <span className="font-bold text-purple-600">{userData?.name}</span>!
              </p>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-xl mb-6">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">You're now logged in</span>
                </div>
              ...
              {userData?.cart?.length > 0 && (
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-4 rounded-xl mb-6">
                  <h4 className="font-bold text-gray-900 mb-2">🛒 Saved Cart Items</h4>
                  <p className="text-sm text-gray-600">
                    You have {userData.cart.length} item{userData.cart.length > 1 ? 's' : ''} in your cart
                  </p>
                </div>
              )}
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
                >
                  Continue Shopping
                </button>
                <button
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4 py-8">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 mb-6">
            <h4 className="font-bold text-gray-900 mb-2 text-sm">🔐 Demo Login</h4>
            <p className="text-xs text-gray-600">
              Use any email from your registered accounts or try: <span className="font-mono">demo@megamart.com</span>
            </p>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              onClick={() => showNotification("Password reset link sent to your email", "success")}
            >
              Forgot password?
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              onClick={() => showNotification("Facebook login coming soon!", "warning")}
            ...
            <button
              type="button"
              onClick={() => showNotification("Google login coming soon!", "warning")}
              className="flex items-center justify-center space-x-2 border border-gray-200 py-3 rounded-xl hover:bg-gray-50 transition-colors"
            >
